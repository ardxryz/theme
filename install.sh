...
display_welcome() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]                                                       [+]${NC}"
  echo -e "${BLUE}[+]                AUTO INSTALLER THEM                [+]${NC}"
...
check_token() {
  ...
  if [ "$USER_TOKEN" = "ardxryzx" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Weh Ke Ardhita/Ryzen Offc Tele @ArdhitaOfficial/@RYZENOFFC1${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/ardxryz/theme/raw/main/C2.zip")
        break
        ;;
      2)
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/ardxryz/installer-theme/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/ardxryz/theme/raw/main/C2.zip
